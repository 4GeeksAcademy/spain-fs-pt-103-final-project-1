        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-2 mt-5 mb-md-0 mb-3">
            ...
            <ul className="list-unstyled">
              <li><a href="https://github.com/alejajaja30" class="link-pretty">Alejandra ·alejajaja30 <PiDog /></a></li>
              <li> <a href="https://github.com/nael-dev" class="link-pretty">Nael ·nael_dev <PiCat /></a></li>
              <li><a href="https://github.com/RCKCode" class="link-pretty">"Ricardo ·RCKCode" <PiHorse /></a></li>
              <li><a href="#!"></a></li>
            </ul>
          </div>

          <div className="col-md-2 mb-md-0 mb-3">
            <h5 className="text-dark text-uppercase fw-bold" lassName="text-uppercase">SIGUENOS</h5>
            <ul className="list-unstyled">
              <li><a href="#!" class="link-pretty"><FaInstagram /> InstagramProtectora</a></li>
              <li><a href="#!" class="link-pretty"><FaFacebook /> FacebookProtectora</a></li>
            </ul>
          </div>
        </div>
      </div>

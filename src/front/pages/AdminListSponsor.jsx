...
export const AdminListSponsor = () => {
    ...
    return (
        <div className="containe-fluid py-8" style={{ backgroundImage: `url(${fotobackground})`, backgroundSize: "cover", backgroundPosition: "center" }}>
            <div className="container py-5">
                <h1 className="text-center mb-4 p-5">Lista de Patrocinadores</h1>
